...
| File | Purpose |
|------|---------|
| `documentation/DOCUMENTATION.md` | Complete platform architecture and technical documentation |
| `documentation/CREATION-GUIDE.md` | Recommended build order from bare hardware to finished homelab |
| `documentation/USER-GUIDE.md` | Day-to-day administration, maintenance, updates, and troubleshooting |
| `documentation/SECURITY.md` | Security practices, credential redaction, and privacy policy |
| `docs/index.html` | Single-page HTML documentation for GitHub Pages |
